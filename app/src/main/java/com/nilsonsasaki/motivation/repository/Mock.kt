package com.nilsonsasaki.motivation.repository

import com.nilsonsasaki.motivation.infra.MotivationConstants
import kotlin.random.Random

data class Phrase(val description: String, val category: MotivationConstants.FilterHandler)

class Mock {

    private val ALL = MotivationConstants.FilterHandler.ALL
    private val MORNING = MotivationConstants.FilterHandler.MORNING
    private val HAPPY = MotivationConstants.FilterHandler.HAPPY
